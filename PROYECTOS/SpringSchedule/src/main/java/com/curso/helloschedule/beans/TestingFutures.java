...
//        test2();
    ...
    private static void test1() throws InterruptedException, ExecutionException {
        ...
        Future<Integer> future = executor.submit(() -> { //executor genera un hilo asíncrono paralelo al hilo principal
            try {
        ...
        Integer result = future.get(); // get() es bloqueante, el hilo principal no sigue hasta que no tiene la respuesta
